...
public class drinks4 extends JFrame {
    public drinks4() {
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Execute SQL query
                    int writeQuery = statement.executeUpdate("UPDATE softdrinks SET stock = stock - 1 WHERE drink_name = 'Maaza'");
                    
                    ResultSet resultSet = statement.executeQuery("SELECT stock from softdrinks WHERE drink_name = 'Maaza'");
                    ...
                    while (resultSet.next()) {
                        ...
                        if (stockCount > 0)  {
                            System.out.println("Remaining Stock(Maaza): "+stockCount);
                            JOptionPane.showMessageDialog(drinks4.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
                        }
                        else {
                            JOptionPane.showMessageDialog(drinks4.this , "THIS ITEM IS OUT OF STOCK");
                        }
                    }
        ...
        JLabel label3 = createLabel3("<html> Brand : Maaza <br/> Item Form : Soft Drinks <br/> Number of Items : 1 <br/> Package Information : Bottle <br/> Item Volume : 600 Millilitres <br/> PRICE : 100/-");
