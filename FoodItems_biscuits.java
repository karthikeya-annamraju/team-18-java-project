...
public class FoodItems_biscuits extends JFrame {
    public FoodItems_biscuits() {
        setTitle("biscuits");
        ...
        button1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                biscuits1 biscuit1 = new biscuits1();
                biscuit1.setVisible(true);
            }
        });
        ...
        button2.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                // Open frame for Electronic Devices
                biscuits2 biscuit2 = new biscuits2();
                biscuit2.setVisible(true);
            }
        });
        ...
        button3.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                // Open frame for Electronic Devices
                biscuits3 biscuit3 = new biscuits3();
                biscuit3.setVisible(true);
            }
        });
        ...
        button4.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                // Open frame for Electronic Devices
                biscuits4 biscuit4 = new biscuits4();
                biscuit4.setVisible(true);
            }
        });
