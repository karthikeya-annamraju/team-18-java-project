        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Execute SQL query
                    int writeQuery = statement.executeUpdate("UPDATE tv SET stock = stock - 1 WHERE tv_name = 'LG'");
                    
                    ResultSet resultSet = statement.executeQuery("SELECT stock from tv WHERE tv_name = 'LG'");
                    ...
                    while (resultSet.next()) {
                        ...
                        if (stockCount > 0)  {
                            ...
                            JOptionPane.showMessageDialog(tv2.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
                        }
                        else {
                            JOptionPane.showMessageDialog(tv2.this , "THIS ITEM IS OUT OF STOCK");
                        }
                    }
