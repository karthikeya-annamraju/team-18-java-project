        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Execute SQL query
                    int writeQuery = statement.executeUpdate("UPDATE lipsticks SET stock = stock - 1 WHERE lipstick_name = 'lipstick4'");
                    
                    ResultSet resultSet = statement.executeQuery("SELECT stock from lipsticks WHERE lipstick_name = 'lipstick4'");
                    ...
                    while (resultSet.next()) {
                        ...
                        if (stockCount > 0)  {
                            System.out.println("Remaining Stock(lipstick4): "+stockCount);
                            JOptionPane.showMessageDialog(lipstick4.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
                        }
                        else {
                            JOptionPane.showMessageDialog(lipstick4.this , "THIS ITEM IS OUT OF STOCK");
                        }
                    }
