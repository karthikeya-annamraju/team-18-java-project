...
public class biscuits3 extends JFrame {
    public biscuits3() {
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Execute SQL query
                    int writeQuery = statement.executeUpdate("UPDATE biscuits SET stock = stock - 1 WHERE biscuit_name = 'Parle Hide & Seek'");
                    
                    ResultSet resultSet = statement.executeQuery("SELECT stock from biscuits WHERE biscuit_name = 'Parle Hide & Seek'");
                    ...
                    while (resultSet.next()) {
                        ...
                        if (stockCount > 0)  {
                            System.out.println("Remaining Stock(Hide & Seek): "+stockCount);
                            JOptionPane.showMessageDialog(biscuits3.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
                        }
                        else {
                            JOptionPane.showMessageDialog(biscuits3.this , "THIS ITEM IS OUT OF STOCK");
                        }
                    }
        ...
        JLabel label3 = createLabel3("<html> Diet Type : Vegetarian <br/> Number of Items : 1 <br/> Net Quantity : 45.0 gram <br/> Brand : parle platina <br/> Item Weight	: 45 Grams <br/> Number of Pieces : 1 <br/> Item Form : Solid <br/> PRICE : 100/-");
