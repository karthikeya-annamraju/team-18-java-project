...
public class chocolate2 extends JFrame {
    public chocolate2() {
        setTitle("chocolate");
        ...
        ImageIcon choco1 = new ImageIcon("images/choco2.jpg");
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Execute SQL query
                    int writeQuery = statement.executeUpdate("UPDATE chocolates SET stock = stock - 1 WHERE chocolate_name = 'Nestle KitKat'");
                    
                    ResultSet resultSet = statement.executeQuery("SELECT stock from chocolates WHERE chocolate_name = 'Nestle KitKat'");
                    ...
                    while (resultSet.next()) {
                        ...
                        if (stockCount > 0)  {
                            System.out.println("Remaining Stock(KitKat): "+stockCount);
                            JOptionPane.showMessageDialog(chocolate2.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
                            break;
                        }
                        else {
                            JOptionPane.showMessageDialog(chocolate2.this , "THIS ITEM IS OUT OF STOCK");
                        }
                    }
