...
public class Shirts1 extends JFrame {
    public Shirts1() {
        setTitle("shirts");
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Execute SQL query
                    int writeQuery = statement.executeUpdate("UPDATE shirts SET stock = stock - 1 WHERE shirt_name = 'Shirt1'");
                    
                    ResultSet resultSet = statement.executeQuery("SELECT stock from shirts WHERE shirt_name = 'Shirt1'");
                    ...
                    while (resultSet.next()) {
                        ...
                        if (stockCount > 0)  {
                            System.out.println("Remaining Stock(Shirt1): "+stockCount);
                            JOptionPane.showMessageDialog(Shirts1.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
                        }
                        else {
                            JOptionPane.showMessageDialog(Shirts1.this , "THIS ITEM IS OUT OF STOCK");
                        }
                    }
