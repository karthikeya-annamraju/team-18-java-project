...
public class laptops3 extends JFrame {
    public laptops3() {
        setTitle("laptops");
        ...
        ImageIcon choco1 = new ImageIcon("images/laptopss3.jpg");
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Execute SQL query
                    int writeQuery = statement.executeUpdate("UPDATE laptops SET stock = stock - 1 WHERE laptop_name = 'Dell'");
                    
                    ResultSet resultSet = statement.executeQuery("SELECT stock from laptops WHERE laptop_name = 'Dell'");
                    ...
                    while (resultSet.next()) {
                        ...
                        if (stockCount > 0)  {
                            System.out.println("Remaining Stock(Dell): "+stockCount);
                            JOptionPane.showMessageDialog(laptops3.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
                        }
                        else {
                            JOptionPane.showMessageDialog(laptops3.this , "THIS ITEM IS OUT OF STOCK");
                        }
                    }
        ...
        // Create labels
        JLabel label1 = createLabel1("DELL LAPTOP");
        JLabel label2 = createLabel2(30,120);
        label2.setIcon(choco1);
        JLabel label3 = createLabel3("<html> Brand : Dell <br/> Model Name : Vostro 3420 <br/> Colour : Dark Silver <br/> Hard Disk Size : 512 GB <br/> RAM Memory Installed Size : 8 GB <br/> PRICE : 49999/- ");
