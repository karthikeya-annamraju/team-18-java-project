...
public class chips1 extends JFrame {
    public chips1() {
        ...
        JLabel label3 = createLabel3("<html> Brand : Lay's <br/> Net Quantity : 50.0 gram <br/> Number of Items : 1 <br/> Type : Potato Chip <br/Diet Type : Vegetarian <br/> Item Form : Chips <br/> Item Weight : 50 Grams <br/> PRICE : 100/-");
