        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Execute SQL query
                    int writeQuery = statement.executeUpdate("UPDATE sarees SET stock = stock - 1 WHERE saree_name = 'Saree1'");
                    
                    ResultSet resultSet = statement.executeQuery("SELECT stock from sarees WHERE saree_name = 'Saree1'");
                    ...
                    while (resultSet.next()) {
                        ...
                        if (stockCount > 0)  {
                            System.out.println("Remaining Stock(Saree1): "+stockCount);
                            JOptionPane.showMessageDialog(Saree1.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
                        }
                        else {
                            JOptionPane.showMessageDialog(Saree1.this , "THIS ITEM IS OUT OF STOCK");
                        }
                    }
