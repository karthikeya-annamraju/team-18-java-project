...
public class laptops4 extends JFrame {
    public laptops4() {
        setTitle("laptops");
        ...
        ImageIcon choco1 = new ImageIcon("images/laptopss4.jpg");
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Execute SQL query
                    int writeQuery = statement.executeUpdate("UPDATE laptops SET stock = stock - 1 WHERE laptop_name = 'ASUS'");
                    
                    ResultSet resultSet = statement.executeQuery("SELECT stock from laptops WHERE laptop_name = 'ASUS'");
                    ...
                    while (resultSet.next()) {
                        ...
                        if (stockCount > 0)  {
                            System.out.println("Remaining Stock(ASUS): "+stockCount);
                            JOptionPane.showMessageDialog(laptops4.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
                        }
                        else {
                            JOptionPane.showMessageDialog(laptops4.this , "THIS ITEM IS OUT OF STOCK");
                        }
                    }
        ...
        JLabel label3 = createLabel3("<html> Brand : ASUS <br/> Model Name : ASUS Vivobook <br/> Screen Size : 14 Inches <br/> Colour : Star Black <br/> CPU Model : Celeron N4020 <br/> PRICE : 49999/-");
