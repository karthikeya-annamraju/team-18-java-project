...
public class mobiles3 extends JFrame {
    public mobiles3() {
        setTitle("mobiles");
        ...
        ImageIcon choco1 = new ImageIcon("images/mobiless3.jpg");
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Execute SQL query
                    int writeQuery = statement.executeUpdate("UPDATE mobiles SET stock = stock - 1 WHERE mobile_name = 'Apple iPhone'");
                    
                    ResultSet resultSet = statement.executeQuery("SELECT stock from mobiles WHERE mobile_name = 'Apple iPhone'");
                    ...
                    while (resultSet.next()) {
                        ...
                        if (stockCount > 0)  {
                            System.out.println("Remaining Stock(Apple iPhone): "+stockCount);
                            JOptionPane.showMessageDialog(mobiles3.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
                        }
                        else {
                            JOptionPane.showMessageDialog(mobiles3.this , "THIS ITEM IS OUT OF STOCK");
                        }
                    }
        ...
        // Create labels
        JLabel label1 = createLabel1("APPLE");
        JLabel label2 = createLabel2(30,120);
        label2.setIcon(choco1);
        JLabel label3 = createLabel3("<html>  Brand : Apple <br/> Model Name : iPhone <br/> Network Service Provider : Unlocked for All Carriers <br/> Operating System : iOS <br/> PRICE : 49999/-");
