        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Execute SQL query
                    int writeQuery = statement.executeUpdate("UPDATE shoes SET stock = stock - 1 WHERE shoe_name = 'Nike'");
                    
                    ResultSet resultSet = statement.executeQuery("SELECT stock from shoes WHERE shoe_name = 'Nike'");
                    ...
                    while (resultSet.next()) {
                        ...
                        if (stockCount > 0)  {
                            System.out.println("Remaining Stock (Nike): "+stockCount);
                            JOptionPane.showMessageDialog(shoes1.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
                        }
                        else {
                            JOptionPane.showMessageDialog(shoes1.this , "THIS ITEM IS OUT OF STOCK");
                        }
                    }
