...
public class mobiles2 extends JFrame {
    public mobiles2() {
        setTitle("mobiles");
        ...
        ImageIcon choco1 = new ImageIcon("images/mobiless4.jpg");
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Execute SQL query
                    int writeQuery = statement.executeUpdate("UPDATE mobiles SET stock = stock - 1 WHERE mobile_name = 'One Plus'");
                    
                    ResultSet resultSet = statement.executeQuery("SELECT stock from mobiles WHERE mobile_name = 'One Plus'");
                    ...
                    while (resultSet.next()) {
                        ...
                        if (stockCount > 0)  {
                            System.out.println("Remaining Stock(One Plus): "+stockCount);
                            JOptionPane.showMessageDialog(mobiles2.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
                        }
                        else {
                            JOptionPane.showMessageDialog(mobiles2.this , "THIS ITEM IS OUT OF STOCK");
                        }
                    }
        ...
        // Create labels
        JLabel label1 = createLabel1("ONEPLUS");
        JLabel label2 = createLabel2(30,120);
        label2.setIcon(choco1);
        JLabel label3 = createLabel3("<html> Brand : OnePlus <br/> Model Name : OnePlus Nord CE4 <br/> Network Service Provider : Unlocked for All Carriers <br/> Operating System : OxygenOS <br/> PRICE : 49999/-");
