...
public class Fashion_heels extends JFrame {
    public Fashion_heels() {
        setTitle("heels");
        ...
        ImageIcon choco2 = new ImageIcon("images/heel2.jpg");
        ImageIcon choco3 = new ImageIcon("images/heel3.jpg");
        ImageIcon choco4 = new ImageIcon("images/heel4.jpg");
        ...
        button1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
               ...
               heels1 heel1 = new heels1();
               heel1.setVisible(true);
            }
        });

        button2.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                heels2 heel2 = new heels2();
                heel2.setVisible(true);
            }
        });
        ...
        button3.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                // Open frame for Electronic Devices
                heels3 heel3 = new heels3();
                heel3.setVisible(true);
            }
        });
        ...
        button4.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                // Open frame for Electronic Devices
                heels4 heel4 = new heels4();
                heel4.setVisible(true);
            }
        });
