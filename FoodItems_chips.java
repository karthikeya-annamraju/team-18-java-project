...
public class FoodItems_chips extends JFrame {
    public FoodItems_chips() {
        setTitle("chips");
        ...
        ImageIcon choco2 = new ImageIcon("images/chips2.jpg");
        ImageIcon choco3 = new ImageIcon("images/chips3.jpg");
        ImageIcon choco4 = new ImageIcon("images/chips4.jpg");
        ...
        button4.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                // Open frame for Electronic Devices
                chips4 chip4 = new chips4();
                chip4.setVisible(true);
            }
        });
    ...
    private JLabel createLabel2(String text) {
        ...
        label2.setBounds(80, 570, 400, 40);
