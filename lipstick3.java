        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Execute SQL query
                    int writeQuery = statement.executeUpdate("UPDATE lipsticks SET stock = stock - 1 WHERE lipstick_name = 'lipstick3'");
                    
                    ResultSet resultSet = statement.executeQuery("SELECT stock from lipsticks WHERE lipstick_name = 'lipstick3'");
                    ...
                    while (resultSet.next()) {
                        ...
                        if (stockCount > 0)  {
                            System.out.println("Remaining Stock(lipstick3): "+stockCount);
                            JOptionPane.showMessageDialog(lipstick3.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
                        }
                        else {
                            JOptionPane.showMessageDialog(lipstick3.this , "THIS ITEM IS OUT OF STOCK");
                        }
                    }
