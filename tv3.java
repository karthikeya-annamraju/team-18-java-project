...
public class tv3 extends JFrame {
    public tv3() {
        setTitle("tvs");
        ...
        ImageIcon choco1 = new ImageIcon("images/tvs3.jpg");
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Execute SQL query
                    int writeQuery = statement.executeUpdate("UPDATE tv SET stock = stock - 1 WHERE tv_name = 'Sony Bravia'");
                    
                    ResultSet resultSet = statement.executeQuery("SELECT stock from tv WHERE tv_name = 'Sony Bravia'");
                    ...
                    while (resultSet.next()) {
                        ...
                        if (stockCount > 0)  {
                            System.out.println("Remaining Stock(Sony Bravia): "+stockCount);
                            JOptionPane.showMessageDialog(tv3.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
                        }
                        else {
                            JOptionPane.showMessageDialog(tv3.this , "THIS ITEM IS OUT OF STOCK");
                        }
                    }
        ...
        // Create labels
        JLabel label1 = createLabel1("SONY TV");
        JLabel label2 = createLabel2(30,120);
        label2.setIcon(choco1);
        JLabel label3 = createLabel3("<html> Screen Size : 43 Inches <br/> Brand : Sony <br/> Internet Services : Netflix,Youtube <br/> Display Technology : LED <br/> Resolution : 4K <br/> PRICE : 49999/-");
