...
public class biscuits2 extends JFrame {
    public biscuits2() {
        setTitle("biscuits");
        ...
        ImageIcon choco1 = new ImageIcon("images/biscuits2.jpg");
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Execute SQL query
                    int writeQuery = statement.executeUpdate("UPDATE biscuits SET stock = stock - 1 WHERE biscuit_name = 'Sunfeast Dark Fantasy'");
                    
                    ResultSet resultSet = statement.executeQuery("SELECT stock from biscuits WHERE biscuit_name = 'Sunfeast Dark Fantasy'");
                    ...
                    while (resultSet.next()) {
                        ...
                        if (stockCount > 0)  {
                            System.out.println("Remaining Stock(Dark Fantasy): "+stockCount);
                            JOptionPane.showMessageDialog(biscuits2.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
                        }
                        else {
                            JOptionPane.showMessageDialog(biscuits2.this , "THIS ITEM IS OUT OF STOCK");
                        }
                    }
        ...
        // Create labels
        JLabel label1 = createLabel1("DARK FANTASY");
        JLabel label2 = createLabel2(30,120);
        label2.setIcon(choco1);
        JLabel label3 = createLabel3("<html> Diet Type : Vegetarian <br/> Number of Items : 1 <br/> Net Quantity : 45.0 gram <br/> Brand : sunfeast <br/> Item Weight : 45 Grams <br/> Number of Pieces : 1 <br/> Item Form : Solid <br/> PRICE : 100/-");
