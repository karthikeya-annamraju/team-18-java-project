...
public class mobiles4 extends JFrame {
    public mobiles4() {
        setTitle("mobiles");
        ...
        ImageIcon choco1 = new ImageIcon("images/mobiless1.jpg");
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Execute SQL query
                    int writeQuery = statement.executeUpdate("UPDATE mobiles SET stock = stock - 1 WHERE mobile_name = 'Samsung Galaxy'");
                    
                    ResultSet resultSet = statement.executeQuery("SELECT stock from mobiles WHERE mobile_name = 'Samsung Galaxy'");
                    ...
                    while (resultSet.next()) {
                        ...
                        if (stockCount > 0)  {
                            System.out.println("Remaining Stock(Samsung Galaxy): "+stockCount);
                            JOptionPane.showMessageDialog(mobiles4.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
                        }
                        else {
                            JOptionPane.showMessageDialog(mobiles4.this , "THIS ITEM IS OUT OF STOCK");
                        }
                    }
