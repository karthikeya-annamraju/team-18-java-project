...
public class Saree2 extends JFrame {
    public Saree2() {
        ...
        ImageIcon choco1 = new ImageIcon("images/saree2.jpg");
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Execute SQL query
                    int writeQuery = statement.executeUpdate("UPDATE sarees SET stock = stock - 1 WHERE saree_name = 'Saree2'");
                    
                    ResultSet resultSet = statement.executeQuery("SELECT stock from sarees WHERE saree_name = 'Saree2'");
                    ...
                    while (resultSet.next()) {
                        ...
                        if (stockCount > 0)  {
                            System.out.println("Remaining Stock(Saree2): "+stockCount);
                            JOptionPane.showMessageDialog(Saree2.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
                        }
                        else {
                            JOptionPane.showMessageDialog(Saree2.this , "THIS ITEM IS OUT OF STOCK");
                        }
                    }
