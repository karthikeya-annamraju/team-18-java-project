...
public class biscuits1 extends JFrame {
    public biscuits1() {
        setTitle("biscuits");
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Execute SQL query
                    int writeQuery = statement.executeUpdate("UPDATE biscuits SET stock = stock - 1 WHERE biscuit_name = 'Britannia Good Day'");
                    
                    ResultSet resultSet = statement.executeQuery("SELECT stock from biscuits WHERE biscuit_name = 'Britannia Good Day'");
                    ...
                    while (resultSet.next()) {
                        ...
                        if (stockCount > 0)  {
                            System.out.println("Remaining Stock(Good Day): "+stockCount);
                            JOptionPane.showMessageDialog(biscuits1.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
                        }
                        else {
                            JOptionPane.showMessageDialog(biscuits1.this , "THIS ITEM IS OUT OF STOCK");
                        }
                    }
        ...
        // Create labels
        JLabel label1 = createLabel1("GOOD DAY");
        JLabel label2 = createLabel2(30,120);
        label2.setIcon(choco1);
        JLabel label3 = createLabel3("<html> Diet Type : Vegetarian <br/> Number of Items : 1 <br/> Net Quantity : 45.0 gram <br/> Brand : Britannia <br/> Item Weight	: 45 Grams <br/> Number of Pieces : 1 <br/> Item Form : Solid <br/> PRICE : 100/-");
    ...
    private JLabel createLabel1(String text) {
        ...
        label1.setBounds(145, 30, 450, 60);
