...
public class heels3 extends JFrame {
    public heels3() {
        setTitle("HEELS");
        ...
        ImageIcon choco1 = new ImageIcon("images/heel3.jpg");
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Execute SQL query
                    int writeQuery = statement.executeUpdate("UPDATE heels SET stock = stock - 1 WHERE heel_name = 'Heel3'");
                    
                    ResultSet resultSet = statement.executeQuery("SELECT stock from heels WHERE heel_name = 'Heel3'");
                    ...
                    while (resultSet.next()) {
                        ...
                        if (stockCount > 0)  {
                            System.out.println("Remaining Stock(Heel3): "+stockCount);
                            JOptionPane.showMessageDialog(heels3.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
                        }
                        else {
                            JOptionPane.showMessageDialog(heels3.this , "THIS ITEM IS OUT OF STOCK");
                        }
                    }
