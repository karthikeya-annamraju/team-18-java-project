...
public class Shirts2 extends JFrame {
    public Shirts2() {
        setTitle("shirts");
        ...
        ImageIcon choco1 = new ImageIcon("images/shirt2.jpg");
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Execute SQL query
                    int writeQuery = statement.executeUpdate("UPDATE shirts SET stock = stock - 1 WHERE shirt_name = 'Shirt2'");
                    
                    ResultSet resultSet = statement.executeQuery("SELECT stock from shirts WHERE shirt_name = 'Shirt2'");
                    ...
                    while (resultSet.next()) {
                        ...
                        if (stockCount > 0)  {
                            System.out.println("Remaining Stock(Shirt2): "+stockCount);
                            JOptionPane.showMessageDialog(Shirts2.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
                        }
                        else {
                            JOptionPane.showMessageDialog(Shirts2.this , "THIS ITEM IS OUT OF STOCK");
                        }
                    }
