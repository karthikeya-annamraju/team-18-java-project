        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Execute SQL query
                    int writeQuery = statement.executeUpdate("UPDATE shirts SET stock = stock - 1 WHERE shirt_name = 'Shirt3'");
                    
                    ResultSet resultSet = statement.executeQuery("SELECT stock from shirts WHERE shirt_name = 'Shirt3'");
                    ...
                    while (resultSet.next()) {
                        ...
                        if (stockCount > 0)  {
                            System.out.println("Remaining Stock(Shirt3): "+stockCount);
                            JOptionPane.showMessageDialog(Shirts3.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
                        }
                        else {
                            JOptionPane.showMessageDialog(Shirts3.this , "THIS ITEM IS OUT OF STOCK");
                        }
                    }
