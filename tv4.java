        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Execute SQL query
                    int writeQuery = statement.executeUpdate("UPDATE tv SET stock = stock - 1 WHERE tv_name = 'Toshiba'");
                    
                    ResultSet resultSet = statement.executeQuery("SELECT stock from tv WHERE tv_name = 'Toshiba'");
                    ...
                    while (resultSet.next()) {
                        ...
                        if (stockCount > 0)  {
                            System.out.println("Remaining Stock(Toshiba): "+stockCount);
                            JOptionPane.showMessageDialog(tv4.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
                        }
                        else {
                            JOptionPane.showMessageDialog(tv4.this , "THIS ITEM IS OUT OF STOCK");
                        }
                    }
