        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Execute SQL query
                    int writeQuery = statement.executeUpdate("UPDATE softdrinks SET stock = stock - 1 WHERE drink_name = 'Sprite'");
                    
                    ResultSet resultSet = statement.executeQuery("SELECT stock from softdrinks WHERE drink_name = 'Sprite'");
                    ...
                    while (resultSet.next()) {
                        ...
                        if (stockCount > 0)  {
                            System.out.println("Remaining Stock (Sprite): "+stockCount);
                            JOptionPane.showMessageDialog(drinks1.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
                        }
                        else {
                            JOptionPane.showMessageDialog(drinks1.this , "THIS ITEM IS OUT OF STOCK");
                        }
                    }
