...
public class Shirts4 extends JFrame {
    public Shirts4() {
        setTitle("shirts");
        ...
        ImageIcon choco1 = new ImageIcon("images/shirt4.jpg");
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Execute SQL query
                    int writeQuery = statement.executeUpdate("UPDATE shirts SET stock = stock - 1 WHERE shirt_name = 'Shirt4'");
                    
                    ResultSet resultSet = statement.executeQuery("SELECT stock from shirts WHERE shirt_name = 'Shirt4'");
                    ...
                    while (resultSet.next()) {
                        ...
                        if (stockCount > 0)  {
                            System.out.println("Remaining Stock(Shirt4): "+stockCount);
                            JOptionPane.showMessageDialog(Shirts4.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
                        }
                        else {
                            JOptionPane.showMessageDialog(Shirts4.this , "THIS ITEM IS OUT OF STOCK");
                        }
                    }
        ...
        JLabel label3 = createLabel3("<html> Material composition : 100% Cotton <br/> Pattern : Solid <br/> Fit type : Classic Fit <br/> Sleeve type : Long Sleeve <br/> Collar style : Normal Collar <br/> Length : Standard Length <br/> PRICE : 12999/-");
