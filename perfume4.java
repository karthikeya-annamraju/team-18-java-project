...
public class perfume4 extends JFrame {
    public perfume4() {
        setTitle("PERFUME");
        ...
        ImageIcon choco1 = new ImageIcon("images/perfume4.jpg");
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                JOptionPane.showMessageDialog(perfume4.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
            }
        });
        ...
        JLabel label3 = createLabel3("<html> Brand : Yardley <br/> Item Form : Liquid <br/> Item Volume : 398 Millilitres <br/> Scent : Ultra Sensual <br/> Special Feature : Long Lasting <br/> PRICE : 899/-");
