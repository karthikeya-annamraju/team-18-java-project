...
public class heels4 extends JFrame {
    public heels4() {
        setTitle("HEELS");
        ...
        ImageIcon choco1 = new ImageIcon("images/heel4.jpg");
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Execute SQL query
                    int writeQuery = statement.executeUpdate("UPDATE heels SET stock = stock - 1 WHERE heel_name = 'Heel4'");
                    
                    ResultSet resultSet = statement.executeQuery("SELECT stock from heels WHERE heel_name = 'Heel4'");
                    ...
                    while (resultSet.next()) {
                        ...
                        if (stockCount > 0)  {
                            System.out.println("Remaining Stock(Heel4): "+stockCount);
                            JOptionPane.showMessageDialog(heels4.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
                        }
                        else {
                            JOptionPane.showMessageDialog(heels4.this , "THIS ITEM IS OUT OF STOCK");
                        }
                    }
