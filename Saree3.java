...
public class Saree3 extends JFrame {
    public Saree3() {
        setTitle("SAREE");
        ...
        ImageIcon choco1 = new ImageIcon("images/saree3.jpg");
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Execute SQL query
                    int writeQuery = statement.executeUpdate("UPDATE sarees SET stock = stock - 1 WHERE saree_name = 'Saree3'");
                    
                    ResultSet resultSet = statement.executeQuery("SELECT stock from sarees WHERE saree_name = 'Saree3'");
                    ...
                    while (resultSet.next()) {
                        ...
                        if (stockCount > 0)  {
                            System.out.println("Remaining Stock(Saree3): "+stockCount);
                            JOptionPane.showMessageDialog(Saree3.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
                        }
                        else {
                            JOptionPane.showMessageDialog(Saree3.this , "THIS ITEM IS OUT OF STOCK");
                        }
                    }
