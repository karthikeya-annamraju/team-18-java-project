...
public class chips2 extends JFrame {
    public chips2() {
        setTitle("chips");
        ...
        ImageIcon choco1 = new ImageIcon("images/chips2.jpg");
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Execute SQL query
                    int writeQuery = statement.executeUpdate("UPDATE chips SET stock = stock - 1 WHERE chips_name = 'Kurkure'");
                    
                    ResultSet resultSet = statement.executeQuery("SELECT stock from chips WHERE chips_name = 'Kurkure'");
                    ...
                    while (resultSet.next()) {
                        ...
                        if (stockCount > 0)  {
                            System.out.println("Remaining Stock (Kurkure): "+stockCount);
                            JOptionPane.showMessageDialog(chips2.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
                        }
                        else {
                            JOptionPane.showMessageDialog(chips2.this , "THIS ITEM IS OUT OF STOCK");
                        }
                    }
        ...
        // Create labels
        JLabel label1 = createLabel1("KURKURE");
        JLabel label2 = createLabel2(30,120);
        label2.setIcon(choco1);
        JLabel label3 = createLabel3("<html> Brand : Kurkure <br/> Net Quantity : 50.0 gram <br/> Number of Items : 1 <br/> Type : Potato Chip <br/Diet Type : Vegetarian <br/> Item Form : Chips <br/> Item Weight : 50 Grams <br/> PRICE : 100/-");
