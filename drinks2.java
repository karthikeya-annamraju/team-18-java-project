...
public class drinks2 extends JFrame {
    public drinks2() {
        setTitle("drinks");
        ...
        ImageIcon choco1 = new ImageIcon("images/drink2.jpg");
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Execute SQL query
                    int writeQuery = statement.executeUpdate("UPDATE softdrinks SET stock = stock - 1 WHERE drink_name = 'Thumbs-Up'");
                    
                    ResultSet resultSet = statement.executeQuery("SELECT stock from softdrinks WHERE drink_name = 'Thumbs-Up'");
                    ...
                    while (resultSet.next()) {
                        ...
                        if (stockCount > 0)  {
                            System.out.println("Remaining Stock (Thumbs-Up): "+stockCount);
                            JOptionPane.showMessageDialog(drinks2.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
                        }
                        else {
                            JOptionPane.showMessageDialog(drinks2.this , "THIS ITEM IS OUT OF STOCK");
                        }
                    }
        ...
        // Create labels
        JLabel label1 = createLabel1("THUMBS UP");
        JLabel label2 = createLabel2(30,120);
        label2.setIcon(choco1);
        JLabel label3 = createLabel3("<html> Brand : Thumbs Up <br/> Item Form : Soft Drinks <br/> Number of Items : 1 <br/> Package Information : Bottle <br/> Item Volume : 600 Millilitres <br/> Net Quantity : 600 millilitre");
