...
public class drinks2 extends JFrame {
    public drinks2() {
        ...
        JLabel label3 = createLabel3("<html> Brand : Thumbs Up <br/> Item Form : Soft Drinks <br/> Number of Items : 1 <br/> Package Information : Bottle <br/> Item Volume : 600 Millilitres <br/> PRICE : 100/-");
