        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Execute SQL query
                    int writeQuery = statement.executeUpdate("UPDATE chocolates SET stock = stock - 1 WHERE chocolate_name = 'Amul Dark Chocolate'");
                    
                    ResultSet resultSet = statement.executeQuery("SELECT stock from chocolates WHERE chocolate_name = 'Amul Dark Chocolate'");
                    ...
                    while (resultSet.next()) {
                        ...
                        if (stockCount > 0)  {
                            System.out.println("Remaining Stock(Amul Dark): "+stockCount);
                            JOptionPane.showMessageDialog(chocolate4.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
                            break;
                        }
                        else {
                            JOptionPane.showMessageDialog(chocolate4.this , "THIS ITEM IS OUT OF STOCK");
                        }
                    }
