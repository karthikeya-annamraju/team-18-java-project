        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Execute SQL query
                    int writeQuery = statement.executeUpdate("UPDATE laptops SET stock = stock - 1 WHERE laptop_name = 'Lenovo'");
                    
                    ResultSet resultSet = statement.executeQuery("SELECT stock from laptops WHERE laptop_name = 'Lenovo'");
                    ...
                    while (resultSet.next()) {
                        ...
                        if (stockCount > 0)  {
                            System.out.println("Remaining Stock(Lenovo): "+stockCount);
                            JOptionPane.showMessageDialog(laptops2.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
                        }
                        else {
                            JOptionPane.showMessageDialog(laptops2.this , "THIS ITEM IS OUT OF STOCK");
                        }
                    }
