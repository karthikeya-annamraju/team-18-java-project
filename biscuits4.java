        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Execute SQL query
                    int writeQuery = statement.executeUpdate("UPDATE biscuits SET stock = stock - 1 WHERE biscuit_name = 'Britannia 50-50'");
                    
                    ResultSet resultSet = statement.executeQuery("SELECT stock from biscuits WHERE biscuit_name = 'Britannia 50-50'");
                    ...
                    while (resultSet.next()) {
                        ...
                        if (stockCount > 0)  {
                            System.out.println("Remaining Stock(50-50 Biscuit): "+stockCount);
                            JOptionPane.showMessageDialog(biscuits4.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
                        }
                        else {
                            JOptionPane.showMessageDialog(biscuits4.this , "THIS ITEM IS OUT OF STOCK");
                        }
                    }
