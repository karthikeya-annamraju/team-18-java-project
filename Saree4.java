...
public class Saree4 extends JFrame {
    public Saree4() {
        setTitle("SAREE");
        ...
        ImageIcon choco1 = new ImageIcon("images/saree4.jpg");
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Execute SQL query
                    int writeQuery = statement.executeUpdate("UPDATE sarees SET stock = stock - 1 WHERE saree_name = 'Saree4'");
                    
                    ResultSet resultSet = statement.executeQuery("SELECT stock from sarees WHERE saree_name = 'Saree4'");
                    ...
                    while (resultSet.next()) {
                        ...
                        if (stockCount > 0)  {
                            System.out.println("Remaining Stock(Saree4): "+stockCount);
                            JOptionPane.showMessageDialog(Saree4.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
                        }
                        else {
                            JOptionPane.showMessageDialog(Saree4.this , "THIS ITEM IS OUT OF STOCK");
                        }
                    }
