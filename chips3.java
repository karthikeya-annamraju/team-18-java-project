...
public class chips3 extends JFrame {
    public chips3() {
        ...
        JLabel label3 = createLabel3("<html> Brand : Too Yumm <br/> Net Quantity : 50.0 gram <br/> Number of Items : 1 <br/> Type : Potato Chip <br/Diet Type : Vegetarian <br/> Item Form : Chips <br/> Item Weight : 50 Grams");
