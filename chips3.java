...
public class chips3 extends JFrame {
    public chips3() {
        setTitle("chips");
        ...
        ImageIcon choco1 = new ImageIcon("images/chips3.jpg");
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Execute SQL query
                    int writeQuery = statement.executeUpdate("UPDATE chips SET stock = stock - 1 WHERE chips_name = 'Too Yum'");
                    
                    ResultSet resultSet = statement.executeQuery("SELECT stock from chips WHERE chips_name = 'Too Yum'");
                    ...
                    while (resultSet.next()) {
                        ...
                        if (stockCount > 0)  {
                            System.out.println("Remaining Stock (Too Yum): "+stockCount);
                            JOptionPane.showMessageDialog(chips3.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
                        }
                        else {
                            JOptionPane.showMessageDialog(chips3.this , "THIS ITEM IS OUT OF STOCK");
                        }
                    }
        ...
        // Create labels
        JLabel label1 = createLabel1("TOO YUMM");
        JLabel label2 = createLabel2(30,120);
        label2.setIcon(choco1);
        JLabel label3 = createLabel3("<html> Brand : Too Yumm <br/> Net Quantity : 50.0 gram <br/> Number of Items : 1 <br/> Type : Potato Chip <br/Diet Type : Vegetarian <br/> Item Form : Chips <br/> Item Weight : 50 Grams <br/> PRICE : 100/-");
