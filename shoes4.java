...
public class shoes4 extends JFrame {
    public shoes4() {
        setTitle("SAREE");
        ...
        ImageIcon choco1 = new ImageIcon("images/shoes4.jpg");
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Execute SQL query
                    int writeQuery = statement.executeUpdate("UPDATE shoes SET stock = stock - 1 WHERE shoe_name = 'Skechers'");
                    
                    ResultSet resultSet = statement.executeQuery("SELECT stock from shoes WHERE shoe_name = 'Skechers'");
                    ...
                    while (resultSet.next()) {
                        ...
                        if (stockCount > 0)  {
                            System.out.println("Remaining Stock (Skechers): "+stockCount);
                            JOptionPane.showMessageDialog(shoes4.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
                        }
                        else {
                            JOptionPane.showMessageDialog(shoes4.this , "THIS ITEM IS OUT OF STOCK");
                        }
                    }
        ...
        JLabel label3 = createLabel3("<html> Material type : Polyurethane <br/> Closure type : Lace-Up <br/> Heel type : Flat <br/> Water resistance level : Not Water Resistant <br/> Sole material : Rubber <br/> Style : Sports Sneakers <br/> PRICE : 1299/-");
