...
public class heels2 extends JFrame {
    public heels2() {
        setTitle("HEELS");
        ...
        ImageIcon choco1 = new ImageIcon("images/heel2.jpg");
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Execute SQL query
                    int writeQuery = statement.executeUpdate("UPDATE heels SET stock = stock - 1 WHERE heel_name = 'Heel2'");
                    
                    ResultSet resultSet = statement.executeQuery("SELECT stock from heels WHERE heel_name = 'Heel2'");
                    ...
                    while (resultSet.next()) {
                        ...
                        if (stockCount > 0)  {
                            System.out.println("Remaining Stock(Heel2): "+stockCount);
                            JOptionPane.showMessageDialog(heels2.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
                        }
                        else {
                            JOptionPane.showMessageDialog(heels2.this , "THIS ITEM IS OUT OF STOCK");
                        }
                    }
