...
public class ac1 extends JFrame {
    public ac1() {
        setTitle("Acs");
        ...
        ImageIcon choco1 = new ImageIcon("images/acs1.jpg");
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Execute SQL query
                    int writeQuery = statement.executeUpdate("UPDATE ac SET stock = stock - 1 WHERE ac_name = 'O General'");
                    
                    ResultSet resultSet = statement.executeQuery("SELECT stock from ac WHERE ac_name = 'O General'");
                    ...
                    while (resultSet.next()) {
                        ...
                        if (stockCount > 0)  {
                            System.out.println("Remaining Stock(O General): "+stockCount);
                            JOptionPane.showMessageDialog(ac1.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
                        }
                        else {
                            JOptionPane.showMessageDialog(ac1.this , "THIS ITEM IS OUT OF STOCK");
                        }
                    }
        ...
        // Create labels
        JLabel label1 = createLabel1("OGENERAL AC");
        JLabel label2 = createLabel2(30,120);
        label2.setIcon(choco1);
        JLabel label3 = createLabel3("<html> Brand : O-general <br/> Capacity : 1.5 Tons <br/> Cooling Power : 18000 British Thermal Units <br/> Special Feature : Dust Filter, Anti-bacterial Filter <br/> PRICE : 49999/-");
