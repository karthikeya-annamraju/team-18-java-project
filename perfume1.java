...
public class perfume1 extends JFrame {
    public perfume1() {
        setTitle("PERFUME");
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                JOptionPane.showMessageDialog(perfume1.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
            }
        });
        ...
        JLabel label3 = createLabel3("<html> Brand : Chanel <br/> Item Form : Liquid <br/> Item Volume : 398 Millilitres <br/> Scent : Ultra Sensual <br/> Special Feature : Long Lasting <br/> PRICE : 899/-");
