...
public class chips4 extends JFrame {
    public chips4() {
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Execute SQL query
                    int writeQuery = statement.executeUpdate("UPDATE chips SET stock = stock - 1 WHERE chips_name = 'Bingo Yumitos'");
                    
                    ResultSet resultSet = statement.executeQuery("SELECT stock from chips WHERE chips_name = 'Bingo Yumitos'");
                    ...
                    while (resultSet.next()) {
                        ...
                        if (stockCount > 0)  {
                            System.out.println("Remaining Stock (Yumitos): "+stockCount);
                            JOptionPane.showMessageDialog(chips4.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
                        }
                        else {
                            JOptionPane.showMessageDialog(chips4.this , "THIS ITEM IS OUT OF STOCK");
                        }
                    }
        ...
        JLabel label3 = createLabel3("<html> Brand : Bingo <br/> Net Quantity : 50.0 gram <br/> Number of Items : 1 <br/> Type : Potato Chip <br/Diet Type : Vegetarian <br/> Item Form : Chips <br/> Item Weight : 50 Grams <br/> PRICE : 100/-");
