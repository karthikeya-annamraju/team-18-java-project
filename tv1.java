...
public class tv1 extends JFrame {
    public tv1() {
        setTitle("tvs");
        ...
        ImageIcon choco1 = new ImageIcon("images/tvs1.jpg");
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Execute SQL query
                    int writeQuery = statement.executeUpdate("UPDATE tv SET stock = stock - 1 WHERE tv_name = 'Samsung'");
                    
                    ResultSet resultSet = statement.executeQuery("SELECT stock from tv WHERE tv_name = 'Samsung'");
                    ...
                    while (resultSet.next()) {
                        ...
                        if (stockCount > 0)  {
                            System.out.println("Remaining Stock(Samsung): "+stockCount);
                            JOptionPane.showMessageDialog(tv1.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
                        }
                        else {
                            JOptionPane.showMessageDialog(tv1.this , "THIS ITEM IS OUT OF STOCK");
                        }
                    }
        ...
        // Create labels
        JLabel label1 = createLabel1("SAMSUNG TV");
        JLabel label2 = createLabel2(30,120);
        label2.setIcon(choco1);
        JLabel label3 = createLabel3("<html> Screen Size : 43 Inches <br/> Brand : Samsung <br/> Internet Services : Netflix,Youtube <br/> Display Technology : LED <br/> Resolution : 4K <br/> PRICE : 49999/-");
