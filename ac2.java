...
public class ac2 extends JFrame {
    public ac2() {
        setTitle("Acs");
        ...
        ImageIcon choco1 = new ImageIcon("images/acs2.jpg");
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    // Execute SQL query
                    int writeQuery = statement.executeUpdate("UPDATE ac SET stock = stock - 1 WHERE ac_name = 'LG'");
                    
                    ResultSet resultSet = statement.executeQuery("SELECT stock from ac WHERE ac_name = 'LG'");
                    ...
                    while (resultSet.next()) {
                        ...
                        if (stockCount > 0)  {
                            System.out.println("Remaining Stock(LG): "+stockCount);
                            JOptionPane.showMessageDialog(ac2.this , "YOU SUCCESSFULLY BOUGHT THIS ITEM!!");
                        }
                        else {
                            JOptionPane.showMessageDialog(ac2.this , "THIS ITEM IS OUT OF STOCK");
                        }
                    }
        ...
        // Create labels
        JLabel label1 = createLabel1("LG AC");
        JLabel label2 = createLabel2(30,120);
        label2.setIcon(choco1);
        JLabel label3 = createLabel3("<html> Brand : LG <br/> Capacity : 1.5 Tons <br/> Cooling Power : 18000 British Thermal Units <br/> Special Feature : Dust Filter, Anti-bacterial Filter <br/> PRICE : 49999/-");
